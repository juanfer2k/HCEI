<?php
require_once __DIR__ . '/bootstrap.php'; // BASE_URL y sesión
require_once __DIR__ . '/access_control.php'; // Proteger esta pagina

// Definir BASE_URL si no está definido por el entorno/config

require_once __DIR__ . '/conn.php';

// --- Si llegamos aqui, el usuario ESTÁ AUTENTICADO ---
...
(function(){
  ...
  function actualizarTABTAM(){
    ...
    setVisible(medicoTripFirma, isTAM);
