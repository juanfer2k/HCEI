...
<div class="container-fluid py-4">
  <div class="inventory-header d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
    <div>
    ...
    <div class="btn-group btn-group-lg" role="group" aria-label="Selector de tipo">
      ...
      <label class="btn btn-outline-primary" for="tipoTam">Inventario TAM</label>
